...
uint8_t const desc_fs_configuration[] = {
    ...
    TUD_CDC_DESCRIPTOR(ITF_NUM_CDC_0, 4, EPNUM_CDC_0_NOTIF, 8, EPNUM_CDC_0_DATA,
                       0x80 | EPNUM_CDC_0_DATA, 64),

    // 2nd CDC: Interface number, string index, EP notification address and
    // size, EP data address (out, in) and size.
    TUD_CDC_DESCRIPTOR(ITF_NUM_CDC_1, 4, EPNUM_CDC_1_NOTIF, 8, EPNUM_CDC_1_DATA,
                       0x80 | EPNUM_CDC_1_DATA, 64),
};
